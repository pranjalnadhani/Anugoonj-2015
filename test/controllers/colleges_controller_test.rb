...
class CollegesControllerTest < ActionController::TestCase
  ...
  test "should create college" do
    assert_difference('College.count') do
      post :create, college: { confirmed: @college.confirmed, contact_no: @college.contact_no, event: @college.event, group_name: @college.group_name, name: @college.name }
    end
  ...
  test "should update college" do
    patch :update, id: @college, college: { confirmed: @college.confirmed, contact_no: @college.contact_no, event: @college.event, group_name: @college.group_name, name: @college.name }
    assert_redirected_to college_path(assigns(:college))
  end
